...
grep -v 'name' /home/slampman/Desktop/pandas.tsv | awk '{print $1,$4,$2}' | sort -k3,3 >> /home/slampman/Desktop/sorted_pandas.txt

	#sorts by the sex columnn, grabs names
...
grep "October" /home/slampman/Desktop/pandas.tsv | grep -cv "female"
...
grep -n '.' /home/slampman/Desktop/pandas.tsv >> /home/slampman/Desktop/panda_names.txt
...
awk -F' ' '{print $5}' /home/slampman/Desktop/pandas.tsv | sort | uniq -u >> unique_places.txt
	...
	# -F helps command to know where columns end/begin, ' ' ' can specify tab separated values since I can't do backslash-t on my keyboard, uniq -u finds unique values, sort is needed for uniq
